...
const cardsDict = {
  ...
  cards: [
    ...
    { question: "THIS BELOVED POST-HARDCORE BAND WAS ALSO POST-EMOCORE, WITH ALUMNI FROM RITES OF SPRING, EMBRACE, AND DAG NASTY.",
    ...
    {
      question: "NOVEMBER 1997: MAXIMUM ROCKNROLL ISSUE #174 PRINTED THIS NAME FOR AN EXTRA-AGGRESSIVE EMO SUBGENRE. THANKS, IN/HUMANITY!",
...
const App = () => {
  ...
  return (
    <div className="app">
      ...
      <button className="next-button" onClick={randomCard}>
        NEXT
      </button>
    </div>
  );
